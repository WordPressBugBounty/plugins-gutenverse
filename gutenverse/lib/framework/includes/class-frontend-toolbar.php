				...
				if ( is_admin() ) {
					$admin_bar->add_node(
						array(
							...
							'title'  => '<span class="gutenverse-adminbar-notifications">' . '<div class="notifications-icon"><img src="' . esc_url( GUTENVERSE_FRAMEWORK_URL_PATH . '/assets/icon/icon-notifications.svg' ) . '"/></div>' . esc_html__( 'Gutenverse Pulse', 'gutenverse' ) . '</span>',
		...
		if ( ! defined( 'GUTENVERSE_PRO' ) ) {
			$admin_bar->add_menu(
				array(
					'id'     => 'gutenverse-pro',
					'parent' => 'gutenverse',
					'title'  => '<span class="gutenverse-pro-right">' . esc_html__( 'Upgrade to PRO', 'gutenverse' ) . '<img src="' . esc_url( GUTENVERSE_FRAMEWORK_URL_PATH . '/assets/icon/icon-crown.svg' ) . '"/> </span>',
	...
	public function setting_toolbar( $admin_bar, $root = 'gutenverse' ) {
		...
		$admin_bar->add_menu(
			array(
				'id'     => 'rate',
				'parent' => 'gutenverse',
				'title'  => esc_html__( 'Rate Us ', 'gutenverse' ) . '<span>★★★★★</span>',
